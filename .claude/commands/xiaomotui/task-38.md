...
Execute task 38 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现发布任务创建"

```
Use the @spec-task-executor agent to implement task 38: "实现发布任务创建" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: 实现发布任务创建

## Instructions
- Implement ONLY task 38: "实现发布任务创建"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 38 --mode complete
```
