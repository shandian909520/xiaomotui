...
Execute task 83 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "部署后端API服务"

```
Use the @spec-task-executor agent to implement task 83: "部署后端API服务" for the xiaomotui specification and include all the below context.
...
## Instructions
- Implement ONLY task 83: "部署后端API服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 83 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 83 --mode complete
```
