...
Execute task 43 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建WiFi连接服务"

```
Use the @spec-task-executor agent to implement task 43: "创建WiFi连接服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 43
- Description: 创建WiFi连接服务

## Instructions
- Implement ONLY task 43: "创建WiFi连接服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 43 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 43 --mode complete
```
