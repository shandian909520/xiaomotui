...
Execute task 76 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建NFC功能测试"

```
Use the @spec-task-executor agent to implement task 76: "创建NFC功能测试" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 76
- Description: 创建NFC功能测试

## Instructions
- Implement ONLY task 76: "创建NFC功能测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 76 --mode complete
