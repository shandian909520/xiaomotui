...
Execute task 9 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建JWT工具类"

```
Use the @spec-task-executor agent to implement task 9: "创建JWT工具类" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 9
- Description: 创建JWT工具类

## Instructions
- Implement ONLY task 9: "创建JWT工具类"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 9 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 9 --mode complete
```
