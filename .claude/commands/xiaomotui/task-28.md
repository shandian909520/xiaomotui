...
Execute task 28 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建AI服务接口类"

```
Use the @spec-task-executor agent to implement task 28: "创建AI服务接口类" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: 创建AI服务接口类

## Instructions
- Implement ONLY task 28: "创建AI服务接口类"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 28 --mode complete
```
