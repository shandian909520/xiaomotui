...
Execute task 39 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建抖音发布服务"

```
Use the @spec-task-executor agent to implement task 39: "创建抖音发布服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 39
- Description: 创建抖音发布服务

## Instructions
- Implement ONLY task 39: "创建抖音发布服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 39 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 39 --mode complete
```
