...
Execute task 6 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建内容任务表迁移文件"

```
Use the @spec-task-executor agent to implement task 6: "创建内容任务表迁移文件" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: 创建内容任务表迁移文件

## Instructions
- Implement ONLY task 6: "创建内容任务表迁移文件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 6 --mode complete
```
