...
Execute task 48 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建素材导入服务"

```
Use the @spec-task-executor agent to implement task 48: "创建素材导入服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 48
- Description: 创建素材导入服务

## Instructions
- Implement ONLY task 48: "创建素材导入服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 48 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 48 --mode complete
```
