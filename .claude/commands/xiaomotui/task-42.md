...
Execute task 42 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建Coupon模型"

```
Use the @spec-task-executor agent to implement task 42: "创建Coupon模型" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 42
- Description: 创建Coupon模型

## Instructions
- Implement ONLY task 42: "创建Coupon模型"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 42 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 42 --mode complete
```
