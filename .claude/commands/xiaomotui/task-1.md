...
Execute task 1 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "初始化ThinkPHP 8.0项目"

```
Use the @spec-task-executor agent to implement task 1: "初始化ThinkPHP 8.0项目" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 1
- Description: 初始化ThinkPHP 8.0项目

## Instructions
- Implement ONLY task 1: "初始化ThinkPHP 8.0项目"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 1 --mode complete
```
