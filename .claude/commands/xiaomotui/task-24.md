...
Execute task 24 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建ContentTask模型"

```
Use the @spec-task-executor agent to implement task 24: "创建ContentTask模型" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: 创建ContentTask模型

## Instructions
- Implement ONLY task 24: "创建ContentTask模型"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 24 --mode complete
```
