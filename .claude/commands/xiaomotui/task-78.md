...
Execute task 78 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建性能基准测试"

```
Use the @spec-task-executor agent to implement task 78: "创建性能基准测试" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 78
- Description: 创建性能基准测试

## Instructions
- Implement ONLY task 78: "创建性能基准测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 78 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 78 --mode complete
```
