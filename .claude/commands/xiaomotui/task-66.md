...
Execute task 66 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建NFC触发页面"

```
Use the @spec-task-executor agent to implement task 66: "创建NFC触发页面" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 66
- Description: 创建NFC触发页面

## Instructions
- Implement ONLY task 66: "创建NFC触发页面"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 66 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 66 --mode complete
```
