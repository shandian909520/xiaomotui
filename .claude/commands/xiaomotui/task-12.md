...
Execute task 12 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建User模型"

```
Use the @spec-task-executor agent to implement task 12: "创建User模型" for the xiaomotui specification and include all the below context.
...
## Instructions
- Implement ONLY task 12: "创建User模型"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 12 --mode complete
```
