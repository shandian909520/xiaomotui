...
Execute task 16 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建认证中间件"

```
Use the @spec-task-executor agent to implement task 16: "创建认证中间件" for the xiaomotui specification and include all the below context.
...
## Instructions
- Implement ONLY task 16: "创建认证中间件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 16 --mode complete
```
