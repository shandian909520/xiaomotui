...
Execute task 8 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "执行数据库迁移"

```
Use the @spec-task-executor agent to implement task 8: "执行数据库迁移" for the xiaomotui specification and include all the below context.
...
## Instructions
- Implement ONLY task 8: "执行数据库迁移"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 8 --mode complete
```
