...
Execute task 81 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建数据库部署脚本"

```
Use the @spec-task-executor agent to implement task 81: "创建数据库部署脚本" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 81
- Description: 创建数据库部署脚本

## Instructions
- Implement ONLY task 81: "创建数据库部署脚本"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 81 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 81 --mode complete
```
