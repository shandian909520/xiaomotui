...
Execute task 31 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建内容生成队列任务"

```
Use the @spec-task-executor agent to implement task 31: "创建内容生成队列任务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: 创建内容生成队列任务

## Instructions
- Implement ONLY task 31: "创建内容生成队列任务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 31 --mode complete
```
