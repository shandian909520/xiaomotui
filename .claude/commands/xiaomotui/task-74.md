...
Execute task 74 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建商家审核页面"

```
Use the @spec-task-executor agent to implement task 74: "创建商家审核页面" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 74
- Description: 创建商家审核页面

## Instructions
- Implement ONLY task 74: "创建商家审核页面"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 74 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 74 --mode complete
```
