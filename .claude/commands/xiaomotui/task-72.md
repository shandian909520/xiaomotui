...
Execute task 72 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建设备管理页面"

```
Use the @spec-task-executor agent to implement task 72: "创建设备管理页面" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 72
- Description: 创建设备管理页面

## Instructions
- Implement ONLY task 72: "创建设备管理页面"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 72 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 72 --mode complete
```
