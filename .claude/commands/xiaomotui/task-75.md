...
Execute task 75 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建API接口测试"

```
Use the @spec-task-executor agent to implement task 75: "创建API接口测试" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 75
- Description: 创建API接口测试

## Instructions
- Implement ONLY task 75: "创建API接口测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 75 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 75 --mode complete
```
