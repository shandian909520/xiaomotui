...
Execute task 5 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建NFC设备表迁移文件"

```
Use the @spec-task-executor agent to implement task 5: "创建NFC设备表迁移文件" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: 创建NFC设备表迁移文件

## Instructions
- Implement ONLY task 5: "创建NFC设备表迁移文件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 5 --mode complete
```
