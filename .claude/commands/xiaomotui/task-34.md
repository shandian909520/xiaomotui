...
Execute task 34 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建平台账号表迁移文件"

```
Use the @spec-task-executor agent to implement task 34: "创建平台账号表迁移文件" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: 创建平台账号表迁移文件

## Instructions
- Implement ONLY task 34: "创建平台账号表迁移文件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 34 --mode complete
```
