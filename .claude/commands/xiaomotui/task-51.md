...
Execute task 51 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现违规内容处理"

```
Use the @spec-task-executor agent to implement task 51: "实现违规内容处理" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 51
- Description: 实现违规内容处理

## Instructions
- Implement ONLY task 51: "实现违规内容处理"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 51 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 51 --mode complete
```
