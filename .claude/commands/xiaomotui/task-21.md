...
Execute task 21 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现设备状态上报"

```
Use the @spec-task-executor agent to implement task 21: "实现设备状态上报" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: 实现设备状态上报

## Instructions
- Implement ONLY task 21: "实现设备状态上报"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 21 --mode complete
```
