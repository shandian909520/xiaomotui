...
Execute task 29 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现百度文心一言服务"

```
Use the @spec-task-executor agent to implement task 29: "实现百度文心一言服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 29
- Description: 实现百度文心一言服务

## Instructions
- Implement ONLY task 29: "实现百度文心一言服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 29 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 29 --mode complete
```
