...
Execute task 80 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "配置生产环境变量"

```
Use the @spec-task-executor agent to implement task 80: "配置生产环境变量" for the xiaomotui specification and include all the below context.
...
## Instructions
- Implement ONLY task 80: "配置生产环境变量"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 80 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 80 --mode complete
```
