...
Execute task 30 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现剪映视频生成服务"

```
Use the @spec-task-executor agent to implement task 30: "实现剪映视频生成服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: 实现剪映视频生成服务

## Instructions
- Implement ONLY task 30: "实现剪映视频生成服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 30 --mode complete
```
