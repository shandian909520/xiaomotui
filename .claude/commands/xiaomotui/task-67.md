...
Execute task 67 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建内容预览页面"

```
Use the @spec-task-executor agent to implement task 67: "创建内容预览页面" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 67
- Description: 创建内容预览页面

## Instructions
- Implement ONLY task 67: "创建内容预览页面"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 67 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 67 --mode complete
```
