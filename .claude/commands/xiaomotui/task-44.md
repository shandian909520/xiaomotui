...
Execute task 44 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现团购跳转服务"

```
Use the @spec-task-executor agent to implement task 44: "实现团购跳转服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 44
- Description: 实现团购跳转服务

## Instructions
- Implement ONLY task 44: "实现团购跳转服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 44 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 44 --mode complete
```
