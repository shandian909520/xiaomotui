...
Execute task 70 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建axios请求封装"

```
Use the @spec-task-executor agent to implement task 70: "创建axios请求封装" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 70
- Description: 创建axios请求封装

## Instructions
- Implement ONLY task 70: "创建axios请求封装"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 70 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 70 --mode complete
```
