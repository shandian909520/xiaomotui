...
Execute task 53 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建实时数据服务"

```
Use the @spec-task-executor agent to implement task 53: "创建实时数据服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 53
- Description: 创建实时数据服务

## Instructions
- Implement ONLY task 53: "创建实时数据服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 53 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 53 --mode complete
```
