...
Execute task 82 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "配置Nginx服务器"

```
Use the @spec-task-executor agent to implement task 82: "配置Nginx服务器" for the xiaomotui specification and include all the below context.
...
## Instructions
- Implement ONLY task 82: "配置Nginx服务器"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 82 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 82 --mode complete
```
