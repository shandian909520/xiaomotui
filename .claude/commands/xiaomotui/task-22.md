...
Execute task 22 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现设备配置获取"

```
Use the @spec-task-executor agent to implement task 22: "实现设备配置获取" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: 实现设备配置获取

## Instructions
- Implement ONLY task 22: "实现设备配置获取"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 22 --mode complete
```
