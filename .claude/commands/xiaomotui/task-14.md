...
Execute task 14 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现微信code换取openid"

```
Use the @spec-task-executor agent to implement task 14: "实现微信code换取openid" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: 实现微信code换取openid

## Instructions
- Implement ONLY task 14: "实现微信code换取openid"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 14 --mode complete
```
