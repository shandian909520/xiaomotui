...
Execute task 77 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建内容生成测试"

```
Use the @spec-task-executor agent to implement task 77: "创建内容生成测试" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 77
- Description: 创建内容生成测试

## Instructions
- Implement ONLY task 77: "创建内容生成测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 77 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 77 --mode complete
```
