...
Execute task 17 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建NfcDevice模型"

```
Use the @spec-task-executor agent to implement task 17: "创建NfcDevice模型" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: 创建NfcDevice模型

## Instructions
- Implement ONLY task 17: "创建NfcDevice模型"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 17 --mode complete
```
