...
Execute task 56 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建智能建议服务"

```
Use the @spec-task-executor agent to implement task 56: "创建智能建议服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 56
- Description: 创建智能建议服务

## Instructions
- Implement ONLY task 56: "创建智能建议服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 56 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 56 --mode complete
```
