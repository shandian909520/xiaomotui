...
Execute task 19 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现设备触发接口"

```
Use the @spec-task-executor agent to implement task 19: "实现设备触发接口" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 19
- Description: 实现设备触发接口

## Instructions
- Implement ONLY task 19: "实现设备触发接口"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 19 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 19 --mode complete
```
