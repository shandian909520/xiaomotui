...
Execute task 46 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现桌号绑定服务"

```
Use the @spec-task-executor agent to implement task 46: "实现桌号绑定服务" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 46
- Description: 实现桌号绑定服务

## Instructions
- Implement ONLY task 46: "实现桌号绑定服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 46 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 46 --mode complete
```
