...
Execute task 2 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "配置数据库连接"

```
Use the @spec-task-executor agent to implement task 2: "配置数据库连接" for the xiaomotui specification and include all the below context.
...
## Instructions
- Implement ONLY task 2: "配置数据库连接"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 2 --mode complete
```
