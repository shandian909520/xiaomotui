...
Execute task 60 for the xiaomotui specification.

## Task Description
创建DeviceManageController
...
Execute with @spec-task-executor agent the following task: "创建DeviceManageController"

```
Use the @spec-task-executor agent to implement task 60: "创建DeviceManageController" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 60
- Description: 创建DeviceManageController

## Instructions
- Implement ONLY task 60: "创建DeviceManageController"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 60 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 60 --mode complete
```
