...
Execute task 32 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "实现任务状态查询"

```
Use the @spec-task-executor agent to implement task 32: "实现任务状态查询" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: 实现任务状态查询

## Instructions
- Implement ONLY task 32: "实现任务状态查询"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 32 --mode complete
```
