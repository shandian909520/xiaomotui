...
Execute task 50 for the xiaomotui specification.
...
Execute with @spec-task-executor agent the following task: "创建素材推荐算法"

```
Use the @spec-task-executor agent to implement task 50: "创建素材推荐算法" for the xiaomotui specification and include all the below context.
...
## Task Details
- Task ID: 50
- Description: 创建素材推荐算法

## Instructions
- Implement ONLY task 50: "创建素材推荐算法"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks xiaomotui 50 --mode complete
...
```bash
claude-code-spec-workflow get-tasks xiaomotui 50 --mode complete
```
